...
router.get('/shopFetch', productController.shopFetch);

router.get('/productDetails/:id', productController.productDetails);
router.get('/productsSearch', productController.productsSearch);
...
router.get('/changePassword', isUserAuthenticated, userController.changePassword);
router.post('/updatePassword', isUserAuthenticated, userController.updatePassword);
...
router.get('/yourCart', cartController.yourCart);
...
router.get('/whishlist', cartController.whishlist);
router.get('/getWishlistData', cartController.getWishlistData);


router.delete('/deletWishlist', cartController.deletWishlist);
